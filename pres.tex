...
\frame{\frametitle{More information on earning a Ph.D. in CS}
The best people to ask about the Ph.D. journey are those who've already completed it.
A few useful resources:

\begin{itemize*}
  \item Document out of CMU covers all the bases, from deciding whether a Ph.D. is a good choice to succeeding as a graduate student.
  \item[]
  \begin{itemize} \item http://www.cs.cmu.edu/~harchol/gradschooltalk.pdf \end{itemize}
  \item Video from Cornell's own Ross Tate debunking common misconceptions about the Ph.D.
  \item[]
  \begin{itemize} \item https://www.youtube.com/watch?v=HkmlqeeBbZ0 \end{itemize}
  \item Video from Philip Guo describing the Ph.D. grind
  \item[] \begin{itemize} \item http://vimeo.com/80236275 \end{itemize}
\end{itemize*}

Do check out other professors' websites for more information.
They often have advice for prospective students.
General or specific, it's worth reading.
}
