...
\begin{itemize*}
  \item You really love research and/or are interested in pursuing a career in
    academia or an industry research lab. (But can also help for normal software dev)
\end{itemize*}
}
...
\begin{itemize*}
  ...
  \item BigRed//Hacks
  \item The (extended) CS community (ACSU, ISSA, CUxD, POPSHOP, Cornell Opensource)
